...
class wpru_admin extends wpru_settings {
    ...
    public static function add_wpru_menu() {
        add_menu_page('WP Redirect url', 'WP Redirect url', 'manage_options', 'kau-wp-redirect-url', array(__CLASS__, "wpru_main_menu"), WPRU_ASSETS_DIR_URI . '/images/wpru-icon.svg');
    }
